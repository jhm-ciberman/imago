...
namespace LifeSim.Generation
{
    public class BiomeGenerator : IWorldGenerationStep
    {
        ...
        protected float _CalculateBiomeTopHeight(World world, float topHeightPercent)
        {
            ...
            return minHeight + MathF.Round(topHeightPercent * delta / Tile.SNAP_INCREMENT) * Tile.SNAP_INCREMENT + Tile.SNAP_INCREMENT / 2f;
        }

        private Dictionary<Biome, TileCover> _MakeRegions()
        {
