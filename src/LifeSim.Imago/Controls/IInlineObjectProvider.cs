...
/// inline object (such as an emoji sprite) to be rendered within a <see cref="TextBlock"/>.
/// </summary>
public readonly struct InlineSegment
{
    ...
    /// <summary>
    /// Gets the texture to draw for inline object segments, or <c>null</c> for text segments.
    /// </summary>
    public readonly ITextureRegion? Texture;

    /// <summary>
    /// Gets the display size in pixels for inline object segments.
    /// </summary>
    public readonly Vector2 Size;

    /// <summary>
    /// Gets a value indicating whether this segment is an inline object rather than plain text.
    /// </summary>
    public bool IsInlineObject => this.Texture != null;
    ...
    /// <summary>
    /// Initializes a new inline object segment.
    /// </summary>
    /// <param name="start">The start index in the source string.</param>
    /// <param name="length">The number of characters consumed by this inline object.</param>
...
/// objects (such as emoji or icons) and determining their textures and display sizes.
/// Text blocks use this to render mixed text-and-image content.
/// </summary>
public interface IInlineObjectProvider
{
    /// <summary>
    /// Parses the given text into segments of plain text and inline objects.
    /// </summary>
    /// <param name="text">The text to parse.</param>
    /// <param name="fontSize">The font size of the text block, for sizing context.</param>
    /// <param name="results">The list to populate with segments. The provider clears it before use.</param>
