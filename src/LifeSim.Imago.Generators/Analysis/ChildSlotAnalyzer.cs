...
{
    private const string ItemsPropertyAttributeName = "LifeSim.Imago.Controls.ItemsPropertyAttribute";
    private const string ContentPropertyAttributeName = "LifeSim.Imago.Controls.ContentPropertyAttribute";
    private const string TextPropertyAttributeName = "LifeSim.Imago.Controls.TextPropertyAttribute";
